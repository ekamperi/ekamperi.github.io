...
[softmax outputs](https://en.wikipedia.org/wiki/Softmax_function) of another network. It works by first training a model using the ground truth labels and then using the output probabilities of the first model to train the second model.
