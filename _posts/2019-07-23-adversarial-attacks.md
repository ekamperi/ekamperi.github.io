...
An intuitive approach to defend against against adversarial attacks is *adversarial training*, i.e. the addition of adversarial examples into the training set during the training process. The first to come up with this defense was Goodfellow et al. proposed to increase the robustness by feeding the model with both original and adversarial examples generated by FGSM and by learning with the modified objective function:
