...
In a previous blog post, we have talked about Bayesian Optimization as a generic method for optimizing a black-box function, $$f(x)$$, that is a function whose formula we don't know.
