...
Excercise for the reader: What data transformation would actually reduce my error? Can you think of some function $$z = f(y)$$, such as that when you calculate $$\frac{dz}{dy}$$, then $$s_z$$ is actually smaller compared to $$s_y$$ for $$y$$ values close to $$1$$?
