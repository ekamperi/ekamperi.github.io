...
The **blue** points are the training data points, the **black** line is the ground truth function, the **magenta** is our approximation after averaging 100 function samples, the **red** dotted lines are the 5% and 95% quantiles and the **faded out blue** lines are the 100 function realizations that we sampled from the MVN.
