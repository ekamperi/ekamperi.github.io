...
description: Notes on how to derive the Riemann curvature tensor using parallel transport, along with an example where we calculate the curvature of the surface of a sphere.
---
