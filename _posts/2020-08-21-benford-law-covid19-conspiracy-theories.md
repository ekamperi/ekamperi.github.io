...
### Relevant work
If you are interested in the topic of verifying COVID-19 epidemiological data, you should really check the following paper by the team of Nicholas Christakis: [Jia, J. S. et al. Population flow drives spatio-temporal distribution of COVID-19 in China. Nature 582, 389–394 (2020)](https://www.nature.com/articles/s41586-020-2284-y). In this work, the researchers used geolocation data from mobile phones in China and generated aggregate population movements from Wuhan to mainland China. People's geographical flow was on par with the subsequent outbreaks in the rest of mainland China in terms of location, intensity, and timing! Besides verification, though, what's more important regarding this modeling is the following. By looking at how people move during an epidemic, you may be able to forecast where the epidemic will strike in the next weeks and take measures to mitigate it.
