...
Supporse for example that we have some data and we want to fit a model of the form $$y = a x$$. Here's is the likelihood function for various values of the parameter $$a$$ (actually it's the logarithm of the likelihood function, but we will talk about this later):

<p align="center">
 <img style="width: 50%; height: 50%" src="{{ site.url }}/images/em_algorithm/linear_regression_mle.png" alt="Log likelihood of linear regression model">
</p>
...
<p align="center">
 <img style="width: 50%; height: 50%" src="{{ site.url }}/images/em_algorithm/histogram_broken _by _dist.png" alt="Histogram of mixed gaussian distribution">
</p>
