...
Next, we load our dataset. Here, I'm using a dataset from my master thesis about comparing complexity indices in volumetric modulated arc therapy plans in prostate cancer. The details don't really matter; any high-dimensional data would do.
